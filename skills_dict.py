...
# print common_items([1, 2, 3, 4], [1, 2, 1, 2])
...
# print unique_common_items([1, 2, 3, 4], [1, 2, 1,2])
###################################################################################################
...
def sum_zero(list1):
    ...
    For example:
        ...
        >>> sort_pairs( sum_zero([3, -3, 2, 1, -2, -1]) )
        [[-3, 3], [-2, 2], [-1, 1]]
    ...
    that's fine, too (even a single zero can pair with itself):
        ...
        >>> sort_pairs( sum_zero([1, 2, 3, -2, -1, 1, 1, 0]) )
        [[-2, 2], [-1, 1], [0, 0]]

    """
    pairs = []
    newlist = set(list1)#remove dupes
    for num in list1:
        if num >0 and -num in newlist: #check if num has a -num in the newlist (bc num, -num = 0)
            pairs.append([num, -num])
    return pairs

# print sum_zero([3, -3, 2, 1, -2, -1])
...
# print find_duplicates(["rose", "is", "a", "rose", "is", "a", "rose"])
...
def word_length(words):
    ...
    mydict = {}
    for word in words:
        mydict.setdefault(len(word), []).append(word)
...
def pirate_talk(phrase):
    ...
    for word in phrase.split():
        pirate_string += pirate_dict.get(word, word) + " "
...
# print adv_word_length_sorted_words(["ok", "an", "apple", "a", "day"])
